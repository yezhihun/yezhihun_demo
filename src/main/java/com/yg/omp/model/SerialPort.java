...
public class SerialPort implements Serializable {
     ...
     * serialport_conntype
     */
    @Column(name = "serialport_conntype")
     ...
     * serialport_baudrate
     */
    @Column(name = "serialport_baudrate")
     ...
     * serialport_databits
     */
    @Column(name = "serialport_databits")
     ...
     * serialport_stopbits
     */
    @Column(name = "serialport_stopbits")
     ...
     */
    @Column(name = "serialport_showstatus")
     ...
     */
    @Column(name = "serialport_is_collect")
     ...
     * 默认：0
     */
    @Column(name = "serialport_sup_interrupt")
     ...
     */
    @Column(name = "serialport_create_time")
     ...
     */
    @Column(name = "serialport_update_time")
